...
<div class="card-tools" style="float: right;">
          ...
          <a href="all-medicine" class="btn btn-primary"><i class="fas fa-list-ul"></i> Lists of Medicines</a>
</div>
<br />
<p></p>
...
<tbody>
   @foreach($stocks_medicine as $key => $stock)     
        <tr>    
            ...
            <td style="text-align: center;">
                                    <form action="{{route('MedicineTransactions.storeStock', $stock->id) }}" method="POST" style="display: inline-block;" class="form-inline">
            ...
            <td>
                ...
                <a href="/medicine-stock-history/{{$stock->id}}" class="btn btn-primary"><i class="fas fa-eye"></i> </a>
            </td>
        </tr>
       @endforeach
</tbody>
   ...
   // var table = $('# your selector').DataTable();
        var table = $('#medicineStockTable').DataTable({
            //dom:'lBfrtip',
                ...
                // dom: 'Bfrtip',
            "columnDefs": [
                { "width": "5%", "targets": 1 },  { "width": "5%", "targets": 5 },{ "width": "5%", "targets": 6 },
        ...
        }).buttons().container().appendTo('#medicineStockTable_wrapper .col-md-6:eq(0)');
