...
<tbody>
   @forelse ($permissions as $permission)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('permission.edit', $permission->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Edit Permission</a>
                            {{--<a href="{{ route('permission.delete', $permission->id) }}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete Permission</a>--}}
                    </tr>
                @empty
                     <tr>
