...
<div class="card-tools" style="float: right;">
    ...
    <div class="card-tools" style="float: right;">
        ...
        <a href="{{ route('role.create') }} " class="btn btn-primary"><i class="fas fa-plus-circle"></i> Add new Role</a>
        </div>   
        </div>
<br />
<br />
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach ($role->permissions as $permission )
                                <!--<button class="btn btn-warning" style="outline:none; box-shadow:none; cursor:default; /*margin-bottom: 8px;*/"><i class="fas fa-shield-alt"></i> {{ $permission->name }}</button>-->
                                <span class="badge badge-pill badge-primary"><i class="fas fa-shield-alt"></i> {{ $permission->name }}</span>
                            @endforeach
                        </td>
